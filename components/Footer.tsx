      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-wrap flex-col sm:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 text-center sm:text-left w-full sm:w-auto">
          ...
          <p className="font-mono text-sm opacity-80">
            ...
            <span className="sm:hidden"> - </span>Secured Project Collection for
            UCS Pyay.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-6 w-full sm:w-auto">
          <a
            ...
            className="hover:text-primary transition-colors tooltip tooltip-top sm:tooltip-left"
            data-tip="Request Invite Code"
          >
            <svg
          ...
          <a
            href="https://github.com/picakhant/pyu_script"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-base-content transition-colors tooltip tooltip-top sm:tooltip-left"
